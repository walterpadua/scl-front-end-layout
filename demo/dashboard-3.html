...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/color-schemes/all-headers/ocean/bootstrap.min.css">
    <link rel="stylesheet" href="./assets/css/color-schemes/all-headers/ocean/nifty.min.css">
...
<body class="jumping centered-layout">
    ...
    <!-- PAGE CONTAINER -->
    <!-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ -->
    <div id="root" class="root mn--slide hd--expanded">
            ...
            <div class="content__header content__boxed rounded-0">
                <div class="content__wrap">
                    ...
                    <div class="text-center">
                        ...
                        <p class="lead mb-0">Hi <a href="#" class="fw-bold btn-link text-decoration-underline">Aaron Chavez</a>! Welcome back to the Dashboard.</p>
                        ...
                        <div class="col-md-7">
                            ...
                            <ol class="list-group list-group-borderless mb-4">
                                <li class="list-group-item d-flex justify-content-between align-items-start px-0">
                                    <div class="me-auto">
                                        <div class="text-head fs-5 fw-semibold">Completed Projects</div>
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-start px-0">
                                    <div class="me-auto">
                                        <div class="text-head fs-5 fw-semibold">Completed Tasks</div>
                                        <small class="text-muted">Curabitur ligula sapien, tincidunt non.</small>
                                    </div>
                                    <span class="badge bg-danger rounded-pill">98</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-start px-0">
                                    <div class="me-auto">
                                        <div class="text-head fs-5 fw-semibold">Resource usage</div>
                                        <small class="text-muted">Consectetuer adipiscing elit.</small>
                                    </div>
                                    <span class="badge bg-info rounded-pill">25%</span>
                                </li>
                                <li class="list-group-item d-flex justify-content-between align-items-start px-0">
                                    <div class="me-auto">
                                        <div class="text-head fs-5 fw-semibold">Earning</div>
                                        <small class="text-muted">Aenean commodo ligula eget dolor.</small>
                                    </div>
                            ...
                            <div class="col-md-4 col-lg-3">
                                <div class="card text-center mb-3 mb-md-0">
                                    <div class="card-body">
                                        ...
                                        <div class="h1 my-4"><i class="demo-psi-data-settings display-3 text-head text-opacity-20"></i></div>
                                        <p class="h4">Storage</p>
                                        <p class="text-head fw-semibold">32TB Total storage</p>
                                        <small class="d-block text-muted my-3">The Big Oxmox advised her not to do so, because there were thousands of bad.</small>
                            ...
                            <div class="col-md-4 col-lg-3">
                                <div class="card text-center mb-3 mb-md-0">
                                    <div class="card-body">
                                        ...
                                        <div class="h1 my-4"><i class="demo-psi-computer-secure display-3 text-head text-opacity-20"></i></div>
                                        <p class="h4">Secured</p>
                                        <p class="text-head fw-semibold">Latest Technology</p>
                                        <small class="d-block text-muted my-3">The Big Oxmox advised her not to do so, because there were thousands of bad.</small>
                            ...
                            <div class="col-md-4 col-lg-3">
                                <div class="card text-center">
                                    <div class="card-body">
                                        ...
                                        <div class="h1 my-4"><i class="demo-psi-consulting display-3 text-head text-opacity-20"></i></div>
                                        <p class="h4">Support</p>
                                        <p class="text-head fw-semibold">We are here 24/7</p>
                                        <small class="d-block text-muted my-3">The Big Oxmox advised her not to do so, because there were thousands of bad.</small>
    ...
    <!-- Initialize [ SAMPLE ] -->
    <script src="./assets/pages/dashboard-3.js" defer></script>
